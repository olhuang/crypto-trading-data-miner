            ...
            envelopes.append(
                _CompareRunEnvelope(
                    ...
                    assumptions={
                        ...
                        "fill_model_version": (params_json.get("effective_assumptions") or {}).get("fill_model_version"),
                        "feature_input_version": (params_json.get("effective_assumptions") or {}).get("feature_input_version"),
                        "benchmark_set_code": (params_json.get("effective_assumptions") or {}).get("benchmark_set_code"),
                        "execution_policy": params_json.get("execution_policy"),
                        "protection_policy": params_json.get("protection_policy"),
                        "assumption_bundle": params_json.get("assumption_bundle"),
                        "assumption_overrides": params_json.get("assumption_overrides"),
                        "effective_assumptions": params_json.get("effective_assumptions"),
                        "session_risk_policy": params_json.get("session_risk_policy") or params_json.get("risk_policy"),
                        "risk_overrides": params_json.get("risk_overrides"),
