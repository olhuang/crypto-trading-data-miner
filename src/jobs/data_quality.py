...
def run_phase4_quality_suite(
    *,
    ...
    return DataQualityRunResult(
        checks_written=gap_result.checks_written + freshness_result.checks_written + duplicate_result.checks_written,
        gaps_written=gap_result.gaps_written + freshness_result.gaps_written + duplicate_result.gaps_written,
    )
