...
|---|---|---|---|---|
| `SR-2026-04-04-04` | Daily loss guardrail | `max_daily_loss_pct` currently uses UTC day boundaries. The long-term strategy/risk/session model will likely need explicit session timezone support. | Add session-level trading-day timezone semantics before paper/live reuse. | `open` |
