...
const BACKTEST_LAUNCH_PRESETS = {
  baseline_perp: {
    ...
    values: {
      ...
      debug_trace_level: "",
      debug_trace_stride: "",
      debug_trace_activity_only: false,
  ...
  const runtimeItems = buildPropertyItemsFromObject(
    {
      ...
      trace_sampling_level: debugTraceSummary.sampling_level,
      trace_sampling_stride: debugTraceSummary.sampling_stride,
      trace_activity_only: debugTraceSummary.activity_only,
    },
    {
...
function renderBacktestRunSummary(detail) {
  ...
  const summaryItems = [
    ...
    {
      label: "Return",
      value: formatPercentRatio(detail.total_return),
      detail: `Annualized ${formatPercentRatio(detail.annualized_return)}`,
    },
    {
      label: "Max Drawdown",
